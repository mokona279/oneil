...
- `entry_funnel.csv` / `gate_breakdown.csv` / `base_stage.csv` — 진단(§11): 종목별
  진입 퍼널·기회일 게이트 분해·현 베이스 단계. 엔진 `record_diagnostics=True`일 때
  채워지며, 비어 있으면 헤더만 있는 파일을 낸다. `reporting/diagnostics.py` 참조.
