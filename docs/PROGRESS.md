...
- [ ] **P1 — R1+R2 (수축 상대화 + 템플릿 완화) + k·룩백 스윕** ← **구현·검증 완료, 트레이드오프 표 승인 대기** (2026-07-14, 세부: `../plan/p1_gates.md`)
  ...
  - **승인 대기**: 보수(k5·alt5·밴드15: 캡처 6.08%/MDD -13.6%) vs 적극(k5·alt5·밴드25: 캡처 7.08%/MDD -15.3%) — 채택 시 rules yaml 반영 + 골든 갱신 + 규칙서 문언 개정
- [ ] **P2 — R3 (단계 리셋 + 4단계 감액)**
- [ ] **P3 — R4a (핸들 피벗)**
- [ ] **P4 — R4b (재진입) 설계 문서 → 구현**
- [ ] **P5 — 통합 워크포워드 + v4 확정**
