...
- [ ] **P4 — R4b (재진입) — 설계·구현·스윕 완료, 승인 대기** (2026-07-16, 세부: `../plan/p4_reentry.md`)
  ...
  - 트레이드오프 표 제출: **권고 채택 c5w3**(§3.3 추적 편입·Q13 스윕에 W축 편입 조건), 대안 c5w1(캡처 보수·기대값 5.29), null-keep 병기 — **사용자 결정 대기**
- [ ] **P5 — 통합 워크포워드 + v4 확정**
